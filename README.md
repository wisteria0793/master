...
4. 感覚的に施設紹介文は、施設の機能面についての影響が大きいのではないかということで、Flickr画像をCLIPでベクトル化し、同じくCLIPでベクトル化した施設紹介文に、距離や類似度に応じて加算してみる。<br>
...
4. 2-2-3のCLIPと結果が変わっていないため、プログラムに誤りがあるか、もしくは、そもそもテキストのみでも十分類似度が高かったため、画像の重みを加えてもその域まで到達しなかった可能性がある。要検討
